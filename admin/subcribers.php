...
if($_SERVER['REQUEST_METHOD']=="POST"){
    if(isset($_POST['delete'])){
        $new_subcribers->n_sub_id = $_POST['sub_id'];
        if($new_subcribers->delete())
        {
                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th>ID</th>
                                                <th>Email</th>
                                                <th>Date Subcribers</th>
                                                <th>Time Subcribers</th>
                                                <th></th>
                                            </tr>
                                        </thead>
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="mediumModalLabel">Subcriber</h5>
                                ...
                                <form role="form" method="POST" action="">
                                    <div class="modal-body">
                                      <p>Are you sure you want to delete this subcriber? This action couldn't be restored</p>
                                    </div>
                                    <div class="modal-footer">
                                        <input type="hidden" name="form_name" value="delete_sub">
