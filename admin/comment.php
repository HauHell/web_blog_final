    ...
    <div class="page-wrapper">
        ...
        <?php
            ...
            if ($num > 0) {
                while ($row = $result->fetch()) {
            ?>
                    <div class="modal fade" id="delete_comment<?php echo $row['n_blog_comment_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <form role="form" method="POST" action="">
                                    <div class="modal-body">
                                      <p>Are you sure you want to delete this comment? This action couldn't be restored</p>
                                    </div>
